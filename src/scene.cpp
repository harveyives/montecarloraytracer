...
//    objects.push_back(cube);
    ...
    if (generate_photon_map) {
        ...
        pm->save_map_to_file(tree_global, "global.tree", photons_global, "global.photon");
        pm->save_map_to_file(tree_caustic, "caustic.tree", photons_caustic, "caustic.photon");
        cout << "DONE" << endl;
    } else {
        // load a prebuild map
        cout << "Loading pre-built maps... " << endl;
        pm->load_map_from_file(tree_global, "global.tree", photons_global, "global.photon");
        pm->load_map_from_file(tree_caustic, "caustic.tree", photons_caustic, "caustic.photon");
        cout << "DONE" << endl;
    }
