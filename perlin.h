#ifndef CODE_PERLIN_H
#define CODE_PERLIN_H
...
public:
    ...
    Vector matrix[n][n];
    // permutations as per Ken Perlin's paper
    int permutations[512];
    vector<int> permutations_original = {
    ...
    Vector get_pixel(int i, int j, float turbulence_power, float turbulence_size, float x_period, float y_period);
};
